...
class _UpdateHeroViewState extends State<UpdateHeroView> {
  ...
  void _submitForm() {
    ...
    Provider.of<HeroProvider>(context, listen: false).updateHero(
      ...
      HeroProvider().getClasses().then((value) {
        if (_flag) {
          setState(() {
            ...
            _flag = false;
            _nameController.text = HeroProvider().itemHeroSelected().name;
            _classSelectedController = HeroProvider().itemHeroSelected().classe;
            _pickedImage = HeroProvider().itemHeroSelected().image;
          });
        }
      });
    }
